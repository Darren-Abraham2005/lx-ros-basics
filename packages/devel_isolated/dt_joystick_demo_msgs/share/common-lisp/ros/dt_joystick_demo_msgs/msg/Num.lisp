...
(cl:in-package dt_joystick_demo_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dt_joystick_demo_msgs-msg:<Num> is deprecated: use dt_joystick_demo_msgs-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dt_joystick_demo_msgs-msg:num-val is deprecated.  Use dt_joystick_demo_msgs-msg:num instead.")
  (num m))
